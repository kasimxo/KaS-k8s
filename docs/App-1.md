...
## 4. Pasos
    ...
    *Nota*: Para poder ejecutar minikube (lanzarlo) tendrás que tener docker ejecutándose
    ...
    4.2 Puedes revisar que se esté ejecutando con 
    > minikube status

    4.3 Y para lanzar el dashboard (lo abrirá en el navegador)
    > minikube dashboard 
    ...
    4.4 Generar una imagen de prueba: 
    ...
    4.5 Exponer la imagen a través de un servicio
